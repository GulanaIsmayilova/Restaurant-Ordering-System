...
import com.restaurant.qrmenu.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/tables/qr/**").permitAll()
                        .requestMatchers("/api/tables/number/**").permitAll()
                        ...
                        .requestMatchers("/api/menu/categories/**").hasRole("ADMIN")
